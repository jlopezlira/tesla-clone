...
const Header = () => {
  return (
    <S.Header>
      <TeslaLogo />
      <div>
        <NavLink href='/'>Model S</NavLink>
        <NavLink href='/'>Model 3</NavLink>
        <NavLink href='/'>Model X</NavLink>
        <NavLink href='/'>Model Y</NavLink>
        <NavLink href='/'>Solar Roof</NavLink>
        <NavLink href='/'>Solar Panels</NavLink>
      </div>
      <div>
